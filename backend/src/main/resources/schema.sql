...
CREATE SEQUENCE IF NOT EXISTS PurchaseOrderExtensionIDSequence START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS InvoiceIDSequence START WITH 100 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS EmployeeIDSequence START WITH 100 INCREMENT BY 1;
